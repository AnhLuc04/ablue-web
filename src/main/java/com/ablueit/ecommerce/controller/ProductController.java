...
//        String host = request.getServerName(); // e.g. store1.mysite.com
...
//            // 🏪 Subdomain Store - lọc theo store
//            Store store = storeOpt.get();
//            if (category.isEmpty()) {
//                productPage = productRepository.findByPriceBetweenAndStore(minPrice, maxPrice, store, pageable);
//            } else {
//                productPage = productRepository.findByCategory_NameAndPriceBetweenAndStore(
//                        category, minPrice, maxPrice, store, pageable
//                );
//            }
//            //model.addAttribute("categories", categoriesRepository.findAllByStore(store));
//        } else {
//            // 🌐 Domain tổng - hiển thị toàn bộ sản phẩm
//            if (category.isEmpty()) {
//                productPage = productRepository.findByPriceBetween(minPrice, maxPrice, pageable);
//            } else {
//                productPage = productRepository.findByCategoryNameAndPriceBetween(
...
//        }
//
//        // Map Product -> ProductCardResponse
